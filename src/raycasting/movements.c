...
/*   Updated: 2023/07/17 13:53:01 by anshimiy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief  If the change is in the limits of the screen/not in a wall, it changes the horizontal view and update the background/angles
 * @note   
 * @param  *rc: 
 * @param  move_x: 
 * @param  move_y: 
...
/**
 * @brief  If the change is in the limits of the screen, it changes the horizontal view and update the background/angles
 * @note   
 * @param  *rc: 
 * @param  change: 
 * @retval None
