...
/*   Updated: 2023/07/12 13:10:30 by alexnshimiy      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_textures(char **file_data, t_game_info *game_info)
{
	...
	if (ft_has_duplicate(file_data, "NO ", 3) || 
        ft_has_duplicate(file_data, "EA ", 3) ||
		ft_has_duplicate(file_data, "SO ", 3) ||
        ft_has_duplicate(file_data, "WE ", 3) ||
        ft_has_duplicate(file_data, "F ", 2) || 
        ft_has_duplicate(file_data, "C ", 2))
