...
/*   Updated: 2023/07/05 13:02:44 by anshimiy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief  Compare the current char with all chars around to see if it is playable(is surounded by 1 or 0)
 * @note   TODO: comment that
 * @param  **map: 
 * @param  i: 
 * @param  j: 
 * @retval 1 if the space is playable(is surounded by 1 or 0), 0 otherwise(if there is a hole or non valid char)
*/
...
void	ft_valid_map(char **file_data, t_game_info *game_info)
{
	...
	if (has_tab == 1)
	{
		printf("Warning: The map contains tabs(\\t). You may encounter some issues...\n");
